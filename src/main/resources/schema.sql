...
-- ----------------------------
-- Table structure for anual_evaluate
-- ----------------------------

CREATE TABLE IF NOT EXISTS `anual_evaluate`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户鉴权表' ROW_FORMAT = Dynamic;

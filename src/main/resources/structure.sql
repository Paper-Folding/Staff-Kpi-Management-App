...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '年度考核表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `staff_info_id` (`staff_info_id`) USING BTREE,
    CONSTRAINT `class_ibfk_1` FOREIGN KEY (`staff_info_id`) REFERENCES `staff_info` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '班主任任职信息表（或称班级表）'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `students`            json                                                                  NULL COMMENT '参赛学生(多人)，json类型，学生竞赛用',
    `tutor_staff_info_id` bigint                                                                NULL DEFAULT NULL COMMENT '学生竞赛：指导教师id\r\n教师获奖：获奖教师id',
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生竞赛、教师获奖表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '日常会议记录表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '差旅发票报销表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '月报信息表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '实践基地表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '研究表，有关科研、教研（课程建设）'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '每学期的教学业绩考核'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `gender`             enum ('女','男','未定') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL     DEFAULT NULL COMMENT '性别，enum(\'女\',\'男\',\'未定\')类型',
    ...
    `idcard`             varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci        NULL     DEFAULT '' COMMENT '身份证号',
    `phone`              varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci         NULL     DEFAULT '' COMMENT '办公电话',
    `long_phone`         varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci         NULL     DEFAULT '' COMMENT '长号',
    `short_phone`        varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci         NULL     DEFAULT '' COMMENT '短号',
    `disabled`           char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci             NULL     DEFAULT NULL COMMENT '用户是否被禁用（删除），\'1\'是\'0\'否',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '教师进修、培训、学术会议等信息表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '导师表，考研，退学警示，记录指导记录信息'
  ROW_FORMAT = Dynamic;
